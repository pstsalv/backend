...
$upd = mysqli_query($conn, "INSERT INTO payment VALUES(NULL,'$owner_id','$amt_paid','approved','$prevamt','$usertoken','auto',now(),'Paystack','$message','$propid','$reference','$user[state]','$user[planid]','$user[agent]','$propdet[canpay_installment]','$user[account_no]','$user[date]','$propdet[type]','$user[branchid]','$user[second_agent]')");
if($upd){
...
$messagen = "Your payment of $damt is successful. This should now reflect on your available payment balance. Regards. Payment Reference #$reference";
