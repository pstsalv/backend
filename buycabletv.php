...
$network = mysqli_real_escape_string($conn, $_POST['type']);
$variationcode = mysqli_real_escape_string($conn, $_POST['variationcode']);
...
$airtimeamount = mysqli_real_escape_string($conn, $_POST['airtimeamount']);
