...
<ul class="menu-tabs kaytabs" style="display:flex">
            ...
            <?php
		$checkall = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='daily' AND state='Delta' ORDER BY id DESC LIMIT 30");
...
<?php }?>  
					...
					<div class="tab-gift-item-2 alltab monthly" style="display:none">
					 <?php
		$checkall2 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='monthly' AND state='Delta' ORDER BY id DESC LIMIT 30");
                        ...
                        <div class="food-box" style="width:100%">
                            <div class="img-box">
							  ...
							  <img src="<?php print $kaylink;?>/pix/<?php print $property2['images'];?>" alt="images" style="height:150px;object-fit:cover">
                                ...
                                <span style="width:auto">₦ <?php print number_format($property2['amount']*2);?></span>
                            </div>
                            <div class="content bg-white">
...
<?php }?> 
					...
					<div class="tab-gift-item-3 alltab outright" style="display:none">
					 <?php
		$checkall3 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND (canpay_installment='outright' OR canpay_installment='promo') AND state='Delta' ORDER BY id DESC LIMIT 30");
                        ...
                        <div class="food-box" style="width:100%">
                            <div class="img-box">
							  ...
							  <img src="<?php print $kaylink;?>/pix/<?php print $property3['images'];?>" alt="images" style="height:150px;object-fit:cover">
                                ...
                                <span style="width:auto">₦ <?php if($property3['promocode']=="notapplicable" || $property3['promocode']=="applicable"){ print number_format($property3['amount'],2);}else{ print number_format($property3['amount']*2);} ?> - <?php print $property3['canpay_installment'];?></span>
                            </div>
                            <div class="content bg-white">
