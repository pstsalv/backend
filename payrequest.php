...
$check =mysqli_query($conn, "SELECT id,property,customerid,agentid,custname,amount,notes,paymethod,status,date,read_status FROM payment_request WHERE id='$payid'");
$payment = mysqli_fetch_array($check);
	//payment owner - correct
		$chowner = mysqli_query($conn, "SELECT id,fname,lname, userid,wallet_bal FROM users WHERE id='$payment[customerid]'");
...
?>
 ...
 <div class="mt-3 bill-topbar">
                     ...
                     <h4 class="fw_6">This request is <?php print $payment['status'];?> </h4>
                 </div>
                 <div class="wrapper-bill" style="margin-bottom:10px">
                     <div class="archive-top">
                         ...
                         <h1><a href="#" class="">₦<?php print number_format($payment['amount'],2);?></a></h1>
                         <h3 class="mt-2 fw_6">Cash Deposit Request</h3>
                         <p class="fw_4 mt-2 text-dark"><?php print $payment['property'];?></p>
                     </div>
                     ...
                     <div class="archive-bottom">
                         ...
                         <ul>
                             ...
                             <li class="list-info-bill">Deposit Amount <span>₦ <?php print number_format($payment['amount'],2);?></span> </li>
                         
                             <li class="list-info-bill">Property <span> #<?php print $payment['property'];?></span> </li>
                             <li class="list-info-bill">Date <span><?php print date('l, F d, Y',strtotime($payment['date']));?></span> </li>
                             <li class="list-info-bill">Customer's Name <span><?php print $owner['fname'].' '.$owner['lname'];?></span> </li>
                            
                             <li class="list-info-bill">Payment Method <span class="text-end"><?php print ucwords($payment['paymethod']);?></span> </li>
                         </ul>
                     </div>
