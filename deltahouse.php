...
<ul class="menu-tabs kaytabs" style="display:flex">
            ...
            <?php
		$checkall = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='short' AND prop_category='Building' AND state='Delta' ORDER BY id DESC LIMIT 30");
...
<h2 class="mb-3 mt-3 text-primary">2 to 5 Years Payment Plan</h2> 
					 <?php
		$checkall2 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='long' AND prop_category='Building' AND state='Delta' ORDER BY id DESC LIMIT 30");
...
<h2 class="mb-3 mt-3 text-primary">Outright Payment Plan</h2> 
					 <?php
		$checkall3 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND (canpay_installment='outright' OR canpay_installment='promo') AND prop_category='Building' AND state='Delta' ORDER BY id DESC LIMIT 30");
