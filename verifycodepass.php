...
$sent = mysqli_query($conn, "UPDATE users SET password='$newpass',status='active' WHERE id='$me'") or die(mysqli_error($conn));

$message = "Your password to access BlissPay has been changed. If you didnt make this change contact Support via email support@blisslegacy.com.ng.";
