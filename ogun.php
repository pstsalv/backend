...
<ul class="menu-tabs kaytabs" style="display:flex">
            ...
            <?php
		$checkall = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='daily' AND state='Ogun' ORDER BY id DESC LIMIT 30");
...
<?php }?>  
					...
					<div class="tab-gift-item-2 alltab monthly" style="display:none">
					 <?php
		$checkall2 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='monthly' AND state='Ogun' ORDER BY id DESC LIMIT 30");
...
<?php }?> 
					...
					<div class="tab-gift-item-3 alltab outright" style="display:none">
					 <?php
		$checkall3 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND (canpay_installment='outright' OR canpay_installment='promo') AND state='Ogun' ORDER BY id DESC LIMIT 30");
