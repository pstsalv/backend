...
$fortoday =  mysqli_query($conn, "SELECT id, date_paid, DATE_FORMAT(date_paid, '%Y-%m-%d') AS dday FROM payment WHERE userid='$me' AND status='uncleared' GROUP BY dday ORDER BY id DESC") OR die(mysqli_error($conn));
