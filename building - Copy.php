...
<ul class="menu-tabs kaytabs" style="display:flex">
                    <li class="nav-tab active" style="flex:1" data-id="daily">Yearly Plan</li>
                   
                    <li class="nav-tab" style="flex:1" data-id="outright">Outright Plan</li>
                </ul>
            ...
            <?php
		$checkall = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment!='outright' AND prop_category='Building' ORDER BY id DESC LIMIT 30");
...
while($property = mysqli_fetch_array($checkall)){
		?>			
                        <div class="food-box" style="width:100%;margin-bottom:10px">
                            <div class="img-box" style="border-radius:10px 10px 0 0">
							  ...
							  <img src="<?php print $kaylink;?>/pix/<?php print $property['images'];?>" alt="images" style="height:150px;object-fit:cover">
                                ...
                                <span style="width:auto">₦ <?php print $property['amttogive'];?> Deposit</span>
                            </div>
...
<?php }?>  
					...
					<div class="tab-gift-item-3 alltab outright" style="display:none">
					 <?php
		$checkall3 = mysqli_query($conn, "SELECT * FROM property WHERE status='Public' AND canpay_installment='outright' AND prop_category='Building' ORDER BY id DESC LIMIT 30");
