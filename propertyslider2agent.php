...
$check =mysqli_query($conn, "SELECT * FROM myproperty WHERE userid='$me' AND propertyid='$propuid'");
...
?>
        ...
        <div class="tf-container swiper-slide" style="margin-left:0px !important;margin-right:5px !important;width:100%" data-propid="<?php print $property['propertyid'];?>">
            <div class="tf-balance-box">
				...
				<a href="#" class="tf-btn bg-info large sheet-open clickme" data-sheet=".createnewvirt_<?php print $count;?>">Create Virtual Account</a>
...
<div class="sheet-modal genslider createnewvirt_<?php print $count;?>" style="height:100%;background:transparent">
 ...
 <div class="tf-panel up panel-open">
          ...
          <form class="tf-form mt-5 createva2" style="margin-bottom:100px">
                ...
                <div class="group-input">
                    ...
                    <input type="email" placeholder="Aa" value="<?php print $count;?><?php print $mydetails['id'];?><?php print $mydetails['email'];?>" class="myemail" name="email" required />
